        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <!-- end tìm kiếm  -->
                     <!-- banner -->
        <section class="breadcrumb-section set-bg" data-setbg="../img/qaq.jpg">
            <div class="container">
                <div class="row">
            ...
            <div class="row">
                        ...
                        <div class="product__details__pic">
                            <div class="product__details__pic__item">
                                <img class="product__details__pic__item--large"
                                    src="../img/product/details/anhc1.webp" alt="">
                            </div>
                            <div class="product__details__pic__slider owl-carousel">
                                <img data-imgbigurl="../img/product/details/anhp1.webp"
                                    src="../img/product/details/anhp1.webp" alt="">
                                <img data-imgbigurl="../img/product/details/anhp2.webp"
                                    src="../img/product/details/anhp2.webp" alt="">
                                <img data-imgbigurl="../img/product/details/anhp3.webp"
                                    src="../img/product/details/anhp3.webp" alt="">
                                <img data-imgbigurl="../img/product/details/anhp4.webp"
                                    src="../img/product/details/anhp4.webp" alt="">
                            </div>
                        </div>
                    </div>
                    <!-- end -->
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="product__details__text">
                        <!-- tên sản phẩm -->
                        <h3>
                            LYOS Futu Logo T-Shirt ( Green )
                        </h3>
                        <!-- end -->
                        <!-- giá -->
                        <div class="product__details__price ">380,000₫</div>
                        <!-- end -->

                        <!-- chọn size -->
                        <div class="select-swap">  
		                        <div data-value="XS" class="n-sd swatch-element xs ">
                                <input class="variant-0" id="swatch-0-xs" type="radio" name="option1" value="XS" data-vhandle="xs" checked="">
                                <label for="swatch-0-xs" class="sd">
                                    <span>XS</span>
                                </label>
                            </div>
                         <div data-value="S" class="n-sd swatch-element s ">
                                <input class="variant-0" id="swatch-0-s" type="radio" name="option1" value="S" data-vhandle="s">
                        ...
                        <div data-value="L" class="n-sd swatch-element l ">
                            ...
                            <div data-value="XL" class="n-sd swatch-element xl ">
                                <input class="variant-0" id="swatch-0-xl" type="radio" name="option1" value="XL" data-vhandle="xl"> 
                        ...
                        <div class="jumbotron">
                        <h2>Mô tả</h2>
                            <p>Chất liệu: 100% Heavy cotton <br>
                                Thông số: Ngang x dài (cm) <br>
                                - Size XS: (45x56) <br>
                                - Size S: (54x66) <br>
                                - Size M: (56x68)<br>
                                - Size L: (58x70)<br>
                                - Size XL: (62x74)<br>>Sai số: ± 2cm <br> 180cm 70kg mặc size XL (oversized).</p>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="product__item">
                        <div class="product__item__pic set-bg" data-setbg="../img/product/dg1.webp">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="product__item">
                        <div class="product__item__pic set-bg" data-setbg="../img/product/dg5.webp">
                            <ul class="product__item__pic__hover">
                                <li><a href="#"><i class="fa fa-heart"></i></a></li>
                                <li><a href="#"><i class="fa fa-retweet"></i></a></li>
                                <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="product__item">
                        <div class="product__item__pic set-bg" data-setbg="../img/product/dg3.webp">
                            <ul class="product__item__pic__hover">
                                <li><a href="#"><i class="fa fa-heart"></i></a></li>
                                <li><a href="#"><i class="fa fa-retweet"></i></a></li>
                                <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="product__item">
                        <div class="product__item__pic set-bg" data-setbg="../img/product/dg4.webp">
                            <ul class="product__item__pic__hover">
                                <li><a href="#"><i class="fa fa-heart"></i></a></li>
                                <li><a href="#"><i class="fa fa-retweet"></i></a></li>
                                <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
